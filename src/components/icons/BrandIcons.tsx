...
/** IEEE Xplore mark — rendered as a compact "IEEE" wordmark badge to match the other brand icons. */
export function IeeeIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="0.5" y="4.5" width="23" height="15" rx="2.5" stroke="currentColor" strokeWidth="1.4" />
      <text
        x="12"
        y="15.3"
        textAnchor="middle"
